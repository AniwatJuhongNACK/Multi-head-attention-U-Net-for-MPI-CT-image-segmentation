...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 11:54:26 2023
...
class AttentionUNet(nn.Module):
    ...
    def __init__(self, img_ch=3, output_ch=1):
        ...
        self.Att5 = AttentionBlock(F_g=512, F_l=512, n_coefficients=256,n_heads=1)
        self.UpConv5 = ConvBlock(1024, 512)

        self.Up4 = UpConv(512, 256)
        self.Att4 = AttentionBlock(F_g=256, F_l=256, n_coefficients=128,n_heads=1)
        self.UpConv4 = ConvBlock(512, 256)

        self.Up3 = UpConv(256, 128)
        self.Att3 = AttentionBlock(F_g=128, F_l=128, n_coefficients=64,n_heads=1)
        self.UpConv3 = ConvBlock(256, 128)

        self.Up2 = UpConv(128, 64)
        self.Att2 = AttentionBlock(F_g=64, F_l=64, n_coefficients=32,n_heads=1)
...
Model_path='/home/aniwat/Desktop/Research/Deep_learning_project/MPI_image_segmentation/Model_chracterizaton/Multi_head_Unet_1block.pth'
...
# # backward_hook = model.Att2.psi.register_full_backward_hook(backward_hook)
# # forward_hook = model.Att2.psi.register_forward_hook(forward_hook)
# backward_hook = model.Att5.psi[1].register_full_backward_hook(backward_hook)
# forward_hook = model.Att5.psi[1].register_forward_hook(forward_hook)
